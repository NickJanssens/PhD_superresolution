...
Manual input
'''
HR_directory = 'F:/MicroCT/Nick/AM23_multiscale/LBM_segmentations/AM23_04micro'
LR_directory = 'F:/MicroCT/Nick/AM23_multiscale/LBM_segmentations/AM23_12micro'
...
op_path_HR = os.path.join(op_path, 'AM23_04micro_LBM_volume')
op_path_LR = os.path.join(op_path, 'AM23_12micro_LBM_volume')
